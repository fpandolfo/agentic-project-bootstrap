...
## Optional Kiro compatibility assumptions

The optional `kiro` pack follows official Kiro conventions verified on 2026-08-17:
...
Kiro is never required by the `core` pack. Player adapters may be added or
removed without changing canonical project ownership.
